            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        <select class="custom-select form-control form-control form-control-lg">
                            <option value="1" selected disabled>Choose your field</option>
                    ...
                    {{-- <div class="form-row align-items-center">
                        <div class="col-auto col-md-6 mb-3">
                          ...
                          <label class="form-label select-label" for="inlineFormCustomSelect">Preference</label>
                    </div> --}}
