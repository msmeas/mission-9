      ...
      <div class="row justify-content-center align-items-center h-150">
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            ...
            <a href="/"><img class="col-md-6 mb-4" src="asset/images/HBSLaw-New-Logo.png" alt="" width="72" height="57" style="align-content:center"></a>
            <h1 class="mb-4 pb-2 pb-md-0 mb-md-5" >Lawyer Registration Form</h1>
            <form>
                <div class="row">
