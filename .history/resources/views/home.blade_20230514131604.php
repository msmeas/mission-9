...
<div class="product_section layout_padding1">
    <div class="container">
      <div class="product_text">Our <span style="color: #5ca0e9;">Expertise</span></div>
            <div class="row">
                <div class="col-md-3">Grid Box 1</div>
            ...
            <div class="row">
                <div class="col-md-3">Grid Box 9</div>
                <div class="col-md-3">Grid Box 10</div>
                <div class="col-md-3">Grid Box 11</div>
                <div class="col-md-3">Grid Box 12</div>
              </div>
            <div class="row">
                <div class="col-md-3">Grid Box 13</div>
                <div class="col-md-3">Grid Box 14</div>
                <div class="col-md-3">Grid Box 15</div>
                <div class="col-md-3">Grid Box 16</div>
            </div>
      </div>
    </div>
</div>
