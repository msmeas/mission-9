          ...
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            ...
            <form>
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="firstName" class="form-control form-control-lg" placeholder="MUSTAFA" />
                      <label class="form-label" for="firstName">First Name</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="lastName" class="form-control form-control-lg" placeholder="KOCADAG" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-outline">
                        <input type="tel" id="password" class="form-control form-control-lg" placeholder="mustafakocadag"/>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-outline">
                            <input type="text" id="phoneNumber" class="form-control form-control-lg" placeholder="085 555 777"/>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="form-outline">
                          <textarea id="education-bg" class="form-control form-control-lg" rows="4" placeholder="Hii"></textarea>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="form-outline">
                          <textarea id="work-accomplishment" class="form-control form-control-lg" rows="4" placeholder="Hii"></textarea>
