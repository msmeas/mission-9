          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-md-6">
                ...
                <p class="banner_text">The Practice Group Aviation is responsible for, inter alia, the preparation, reviewing and execution of aircraft operating lease agreements, the related conditions precedent documents and the issuance of legal opinions for various airlines in order to come to a closing on the lease of commercial aircrafts. </p>
              </div>
              <div class="col-md-6">
