      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="col-md-4">
            <h2>Our Expertise</h2>
            <ul>
                <li><a href="#">○ AIRCRAFT LEASING & PURCHASE</a></li>
                <li></li><a href="#">BANKING & FINANCE</a>
                <li></li><a href="#">CAPITAL MARKET AND M&A</a>
                <li></li><a href="#">CONSTRUCTION & REAL ESTATE DEVELOPEMENT</a>
                <li></li><a href="#">CUSTOMS AND TAX</a>
                <li></li><a href="#">DISPUTE RESOLUTION AND LITIGATION</a>
                <li></li><a href="#">ENERGY, INFASTRUCTURE & MINING</a>
                <li></li><a href="#">FOREIGN DESKS</a>
                <li></li><a href="#">GAMING, HOSPITALITY & TOURISM</a>
                <li></li><a href="#">GENERAL CORPORATE & INTVESTMENT</a>
                <li></li><a href="#">INSURANCE AND TRUST</a>
                <li></li><a href="#">INTELLETUAL PROPERTY RIGHTS</a>
                <li></li><a href="#">LABOR AND INDUSTRIAL RELATIONS</a>
                <li></li><a href="#">TELECOMMUNICATION AND TECHNOLOGY</a>
                {{-- <li>○</li> --}}
            </ul>
          </div>
      </div>
