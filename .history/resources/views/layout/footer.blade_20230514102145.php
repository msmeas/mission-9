        ...
        <div class="footer_section_2">
          <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-3">
                ...
                <p class="ipsum_text_2">Find Lawyer web application is a user-friendly platform designed to help clients find the ideal lawyer for their specific legal needs.</p>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-3">
