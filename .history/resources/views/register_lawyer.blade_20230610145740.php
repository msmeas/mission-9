                ...
                <li><a href="#">○ INTELLETUAL PROPERTY RIGHTS</a></li>
                    <div class="form-group col-md-6 mb-3">
                        <select id="inputState" class="select form-control">
                            <option value="1" disabled>Choose your field</option>
                            <option value="2">AIRCRAFT LEASING & PURCHASE</option>
                            <option value="3">BANKING & FINANCE</option>
                            <option value="4">CONSTRUCTION & REAL ESTATE DEVELOPEMENT</option>
                            <option value="5">CUSTOMS AND TAX</option>
                            <option value="6">DISPUTE RESOLUTION AND LITIGATION</option>
                            <option value="7">ENERGY, INFASTRUCTURE & MINING</option>
                            <option value="8">FOREIGN DESKS</option>
                            <option value="9">GAMING, HOSPITALITY & TOURISM</option>
                            <option value="10">GENERAL CORPORATE & INTVESTMENT</option>
                            <option value="11">INSURANCE AND TRUST</option>
                            <option value="12">INTELLETUAL PROPERTY RIGHTS</option>
                            <option value="12">INTELLETUAL PROPERTY RIGHTS</option>
                        </select>
                        <label class="form-label select-label">Choose your field</label>
                      </div>
