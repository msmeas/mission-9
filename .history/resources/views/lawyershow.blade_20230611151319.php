      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-3">
            <h2>Education</h2>
            <ul>
                <li>Bachelor of Laws, Specialization Fiscal Law, Erasmus University Rotterdam, the Netherlands, 2007
                    Propaedeutic Diploma Dutch Law, Erasmus University Rotterdam, the Netherlands, 2002</li>
            </ul>
          </div>
      </div>
    </div>
