...
<div class="layout_padding0">
    <div class="container">
        <main class="form-signin" style="align-items: center; padding-top: 40px; padding-bottom: 40px;">
            <form>
            <a href="/"><img class="mb-4" src="asset/images/HBSLaw-New-Logo.png" alt="" width="72" height="57" style="margin-left:100px"></a>
            <h1 class="h3 mb-3 fw-normal" style="margin-left:50px">Sign in Form</h1>
      ...
      <div class="row justify-content-center align-items-center h-150">
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            ...
            <h1 class="mb-4 pb-2 pb-md-0 mb-md-5" style="margin-left:130px">Client Registration Form</h1>
              <form>
                <div class="row">
